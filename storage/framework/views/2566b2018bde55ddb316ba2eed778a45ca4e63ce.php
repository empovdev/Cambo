...
<?php $__env->startSection('content'); ?>
    ...
    <div class="lang-content-box">
        <form action="<?php echo e(route('event.vendor.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post">
            <?php echo csrf_field(); ?>
            <div class="form-add-service">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-tour-location">
                        <?php echo $__env->make('Event::admin/event/location',["is_smart_search"=>"1"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        jQuery(function ($) {
            new BravoMapEngine('map_content', {
                fitBounds: true,
                center: [<?php echo e($row->map_lat ?? "11.562108"); ?>, <?php echo e($row->map_lng ?? "104.888535"); ?>],
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project for sale\booking-core.2.0.foll\modules\Event\Views\frontend\vendorEvent\detail.blade.php ENDPATH**/ ?>