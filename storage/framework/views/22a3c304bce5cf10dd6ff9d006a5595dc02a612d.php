<?php if(!empty($seo_meta)): ?>
    ...
    <?php
        ...
        if(!empty($page_title) and empty($seo_meta['is_homepage'])){
            $page_title .= " - ".setting_item_with_lang('site_title' ,false,'Cambofair');
        }
        if(empty($page_title)){
            $page_title = setting_item_with_lang('site_title' ,false,'Cambofair');
        }
...
<?php endif; ?>
<?php /**PATH D:\project for sale\booking-core.2.0.foll\modules\Layout\parts\seo-meta.blade.php ENDPATH**/ ?>