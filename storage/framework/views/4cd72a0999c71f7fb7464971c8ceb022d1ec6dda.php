...
<div class="sidebar-user">
    ...
    <div class="user-profile-plan">
        <?php if( !Auth::user()->hasPermissionTo("dashboard_vendor_access") ): ?>
            <a href=" <?php echo e(route("user.upgrade_vendor")); ?>"><?php echo e(__("Become a organizer")); ?></a>
        <?php endif; ?>
    </div>
...
<?php /**PATH D:\project for sale\booking-core.2.0.foll\modules\User\Views\frontend\layouts\sidebar.blade.php ENDPATH**/ ?>