                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                            ...
                            <?php if($updater_latest_version = setting_item('updater_latest_version') and version_compare(config('app.version'),$updater_latest_version,'=')): ?>
                                <p class="alert-success alert"><strong><?php echo e(__("You are using newest version of Cambofair: :version",['version'=>$updater_latest_version])); ?></strong></p>
                            <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project for sale\booking-core.2.0.foll\modules\Core\Views\admin\updater\index.blade.php ENDPATH**/ ?>