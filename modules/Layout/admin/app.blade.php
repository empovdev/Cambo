...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Cambofair'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Cambofair by')}} <a href="{{__('https://www.bookingcore.org')}}" target="_blank">{{__('CT5KH Team')}}</a>
                    </div>
                    <div class="col-md-6">
