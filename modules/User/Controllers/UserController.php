...
class UserController extends FrontendController
{
    ...
    public function upgradeVendor(Request $request){
        ...
        if(!empty($vendorRequest)){
            return redirect()->back()->with('warning', __('You have just done the become organizer request, please wait for the Admin\'s approved'));
        }
        ...
        return redirect()->back()->with('success', __('Request organizer success!'));
    }
